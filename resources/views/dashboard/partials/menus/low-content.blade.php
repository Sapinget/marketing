...
<!-- Low Konten View -->
                    <div v-if="activeTab === 'low_content_platform'" class="space-y-6 animate-fadeIn pb-10">
                        <section class="section-card section-card-body">
                            <div class="flex flex-col md:flex-row md:items-center justify-between gap-3 md:gap-5">
                                <div class="flex items-center gap-4">
                                    ...
                                    <div>
                                        <h2 class="text-lg font-semibold text-slate-900">Low Konten</h2>
                                        <p class="type-body text-slate-500">Low 5 konten per platform - data 0 penuh
                                            diabaikan</p>
                                    </div>
                                </div>
                        ...
                        <div v-if="lowContentByPlatform.length === 0"
                            ...
                            <p class="text-[11px] font-bold uppercase tracking-widest">Tidak ada data pada periode ini
                            </p>
                        </div>
                        ...
                        <div v-else class="space-y-4">
                            ...
                            <div class="md:hidden space-y-3">
                                <div v-for="(row, idx) in lowContentCombined" :key="'low-mobile-' + idx"
                                    ...
                                    <div class="mobile-data-card__header">
                                        <span
                                            class="px-2.5 py-1 rounded-full text-[9px] font-bold uppercase tracking-wider bg-rose-100 text-rose-700">#{{ idx + 1 }}</span>
                                    ...
                                    <div class="mobile-data-card__summary">
                                        <div>
                                            ...
                                            <div class="type-body font-bold text-rose-500">{{ formatNumber(row.views) }}
                                            </div>
                                        </div>
                                        <div>
                            ...
                            <div class="hidden md:block section-card section-card-shell">
                                <div class="px-6 py-4 border-b border-slate-50 flex items-center justify-between">
                                    ...
                                    <span class="type-meta text-slate-400">{{ lowContentCombined.length }}
                                        konten</span>
                                </div>
                                <div class="overflow-x-auto">
                                    <table class="w-full text-[10.5px] text-left border-collapse min-w-[640px]">
                                        ...
                                        <tbody class="divide-y divide-slate-50">
                                            <tr v-for="(row, idx) in lowContentCombined" :key="'lc_' + idx"
                                                class="hover:bg-slate-50/50 transition-colors">
                                                <td class="px-6 py-3 text-center text-[11px] text-slate-400">{{ idx + 1 }}</td>
                                                <td
                                                ...
                                                <td
                                                    class="px-6 py-3 text-right text-[11px] font-semibold text-rose-500">
                            ...
                            <!-- Per Platform -->
                            <div v-for="group in lowContentByPlatform" :key="group.platform"
                                ...
                                <div class="overflow-x-auto">
                                    <table class="w-full text-[10.5px] text-left border-collapse min-w-[580px]">
                                        ...
                                        <tbody class="divide-y divide-slate-50">
                                            <tr v-for="(row, idx) in group.rows" :key="group.platform + '_low_' + idx"
                                                class="hover:bg-slate-50/50 transition-colors">
                                                <td class="px-6 py-3 text-center text-[11px] text-slate-400">{{ idx + 1 }}</td>
                                                <td
                                                    class="px-6 py-3 text-[11px] font-semibold text-slate-800 max-w-[200px] truncate">
